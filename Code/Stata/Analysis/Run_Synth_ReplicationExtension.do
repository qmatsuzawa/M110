/*======= This estimates synthetic control for OR & WA using Joshi & Spencer specification =========*/
...
preserve
	...
	// Run Everything!
	synth `y' `match' , trunit(`trunit') trperiod(`trtime') keep("Estimate/SC_Main/ReplicationExtention/Synth_`y'_`trunit'_start`startmo'", replace)
restore
}
}
}
...
preserve
	...
	gen trtime = `trtime'
	export delimited "Estimate/SC_Main/ReplicationExtention/Placebos_`y'`trunit'_start`startmo'.csv", replace
